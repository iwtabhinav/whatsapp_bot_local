...
class UltraRobustWhatsAppBot extends EventEmitter {
    constructor(config = {}) {
        ...
        this.maxConnectionAttempts = 10000; // Reasonable limit but higher than 5
    ...
    async initialize() {
        ...
        if (!sessionStatus.isValid) {
            ...
            // INCREASED from 5 to 15 to prevent aggressive session clearing
    ...
    saveConnectionState() {
        try {
            ...
            const connectionState = {
                ...
                maxConnectionAttempts: this.maxConnectionAttempts || 10000,
