...
class WhatsAppService {
  constructor() {
    ...
    this.qrRetries = 0;
    this.maxQrRetries = 10000; // Increased to match main bot maxConnectionAttempts
  ...
  setupEventHandlers(handlers) {
    ...
    // QR Code generation - only when manually triggered
    this.client.on('qr', async (qr) => {
      ...
      try {
        ...
        // QR refresh monitoring disabled - QR will only be generated manually
