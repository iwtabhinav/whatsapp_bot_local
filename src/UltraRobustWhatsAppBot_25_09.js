    ...
    async initialize() {
        ...
        try {
            ...
            if (this.connectionAttempts < this.maxConnectionAttempts) {
                ...
                console.error('❌ Max connection attempts reached. Clearing session and forcing QR generation...');
                ...
                console.log('🔄 Waiting 2 minutes before clearing session and retrying...');
                setTimeout(() => {
                    console.log('🗑️ Clearing session after max attempts...');
                    this.sessionValidator.clearInvalidSession();
...
🔄 *Attempts:* ${this.connectionAttempts}/${this.maxConnectionAttempts}
